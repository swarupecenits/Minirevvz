...
export function PublicLayout() {
  ...
  return (
    <div className="min-h-screen flex flex-col relative">
      {/* Sticky Header */}
      <header
        className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-zinc-950/80 backdrop-blur-md border-b border-white/10 h-20 flex items-center' : 'bg-transparent h-24 flex items-center'}`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex items-center justify-between">
          <Link
            ...
            <img src={logo} alt={BRAND_NAME} className="h-16 md:h-18 w-auto object-contain mix-blend-screen scale-[1.5] md:scale-[2] origin-left" />
          </Link>
